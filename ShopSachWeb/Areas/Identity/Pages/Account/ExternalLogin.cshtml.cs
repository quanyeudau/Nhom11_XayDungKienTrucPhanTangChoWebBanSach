    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            else
            {
                ...
                if (info.Principal.HasClaim(c => c.Type == ClaimTypes.Email))
                {
                    ...
                    string name = info.Principal.FindFirstValue(ClaimTypes.Name) ?? email.Split('@')[0];

                    // Kiểm tra xem email đã tồn tại chưa
                    var existingUser = await _userManager.FindByEmailAsync(email);
                    if (existingUser != null)
                    {
                        // Nếu email đã tồn tại, thêm external login và đăng nhập
                    ...
                    // Set thông tin cơ bản cho user
                    if (user is ApplicationUser applicationUser)
                    {
                        applicationUser.Name = name;
                        applicationUser.EmailConfirmed = true; // Đánh dấu email đã xác nhận vì đã xác thực qua Google
                    }
                ...
                ErrorMessage = "Không thể tạo tài khoản tự động. Vui lòng thử lại.";
                return RedirectToPage("./Login", new { ReturnUrl = returnUrl });
            }
        }
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // Set additional properties for ApplicationUser
                if (user is ApplicationUser applicationUser)
                {
